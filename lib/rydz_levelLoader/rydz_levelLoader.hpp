...
//TODO:
//Zoptymalizowa� liczenie tr�jk�t�w poprzez indeksowanie (chwilowo duplikuj� si� 2 vertexy per plane)
...
rl::Mesh createPlaneMesh(brushFace face) {
    ...
    //Raylib robi tutaj kalkulacje z rozdzielczo�ci (do subdivision), ale my chyba nie potrzebujemy
    int vertexCount = 6;
