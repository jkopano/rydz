...
inline auto plane(float width = 10, float length = 10, int res_x = 1,
                  int res_z = 1) -> Mesh {
...
inline auto torus(float radius = 0.5f, float size = 0.2f, int rad_seg = 16,
                  int sides = 16) -> Mesh {
...
inline auto knot(float radius = 0.5f, float size = 0.2f, int rad_seg = 16,
                 int sides = 16) -> Mesh {
